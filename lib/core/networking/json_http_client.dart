...
final class JsonHttpClient {
  ...
  AppFailure _failure(Map<String, dynamic> body, int status) {
    ...
    final failureCode = switch (code) {
      ...
      'INVALID_REGISTRATION' => FailureCode.invalidRegistration,
      'REGISTRATION_RATE_LIMITED' => FailureCode.registrationRateLimited,
      'EMAIL_UNAVAILABLE' => FailureCode.unavailable,
